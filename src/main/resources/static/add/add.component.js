...
component('add', {
    ...
    .controller('addition',
        function($scope, $location, $http) {
            ...
            $scope.myDefaultColor20 = {"color" : "grey"}; $scope.my16DefaultColor20 = {"color" : "grey"};
            $scope.my17DefaultColor20 = {"color" : "grey"}; $scope.my18DefaultColor20 = {"color" : "grey"};
            ...
            $scope.my11Func16 = function() {$scope.my11DefaultColor16 = {"color" : "black"}};
            $scope.my12Func16 = function() {$scope.my12DefaultColor16 = {"color" : "black"}};
            $scope.my15Func16 = function() {$scope.my15DefaultColor16 = {"color" : "black"}};
            $scope.myFunc19 = function() {$scope.myDefaultColor19 = {"color" : "black"}};
            $scope.myFunc20 = function() {$scope.myDefaultColor20 = {"color" : "black"}};
            $scope.my16Func20 = function() {$scope.my16DefaultColor20 = {"color" : "black"}};
            $scope.my17Func20 = function() {$scope.my17DefaultColor20 = {"color" : "black"}};
            $scope.my18Func20 = function() {$scope.my18DefaultColor20 = {"color" : "black"}};
