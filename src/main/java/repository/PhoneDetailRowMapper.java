...
public class PhoneDetailRowMapper implements RowMapper<PhoneDetail> {
    ...
    public PhoneDetail mapRow(ResultSet rs, int i) throws SQLException, DataAccessException {
        ...
        return  PhoneDetail.builder()
                ...
                .android(Android.AndroidBuilder.newInstance()
                        .os(rs.getString("os_name"))
                        .ui(rs.getString("ui")).build()
                        )
                //.battery(new Battery.BatteryBuilder()
                .battery(Battery.BatteryBuilder.newInstance()
                ...
                .camera(Camera.CameraBuilder.newInstance()
                        .features(features)
                        .primary(rs.getString("primary_name"))
                        .build()
                        )
                //.connectivity(new Connectivity.ConnectivityBuilder()
                .connectivity(Connectivity.ConnectivityBuilder.newInstance()
                ...
                .display(Display.DisplayBuilder.newInstance()
                ...
                .hardware(Hardware.HardwareBuilder.newInstance()
                ...
                .sizeAndWeight(SizeAndWeight.SizeAndWeightBuilder.newInstance()
                        .dimensions(dimensions)
                        .weight(rs.getString("weight"))
                        .build()
                        )
                //.storage(new Storage.StorageBuilder()
                .storage(Storage.StorageBuilder.newInstance()
